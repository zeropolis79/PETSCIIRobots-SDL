CXXFLAGS :=-g -std=c++11 -DPLATFORM_SCREEN_WIDTH=2864 -DPLATFORM_SCREEN_HEIGHT=1400 -DPLATFORM_MAP_WINDOW_TILES_WIDTH=117 -DPLATFORM_MAP_WINDOW_TILES_HEIGHT=57 -DPLATFORM_TILE_BASED_RENDERING -DPLATFORM_IMAGE_BASED_TILES -DPLATFORM_IMAGE_SUPPORT -DPLATFORM_SPRITE_SUPPORT -DPLATFORM_COLOR_SUPPORT -DOPTIMIZED_MAP_RENDERING
LDFLAGS :=
